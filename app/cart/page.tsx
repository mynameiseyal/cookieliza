    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="mb-6 sm:mb-8">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 text-gray-600 hover:text-pink-600 transition-colors mb-4 text-sm sm:text-base"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl divide-y divide-gray-100 border border-pink-100">
              {items.map((item) => (
                <div key={item.id} className="p-4 sm:p-6 hover:bg-pink-50/50 transition-colors">
                  <div className="flex items-start sm:items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-base sm:text-lg font-semibold text-pink-600">₪{item.price}</p>
                      ...
                      <div className="flex items-center justify-between mt-3 sm:hidden">
                        <div className="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1.5">
                          <button
                            ...
                            className="p-1 text-gray-600 hover:text-pink-600 hover:bg-white rounded-full transition-all"
                          >
                    ...
                    <button
                      ...
                      className="p-2 sm:p-3 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-all flex-shrink-0"
                      title="הסר מהעגלה"
                    >
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl text-white lg:sticky lg:top-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 space-y-3">
                ...
                <button className="w-full bg-white text-pink-600 py-3 sm:py-4 rounded-xl sm:rounded-2xl hover:bg-pink-50 transition-all transform hover:scale-105 shadow-lg font-bold text-base sm:text-lg">
                  המשך לתשלום 💳
                </button>
                
                <Link
                  href="/"
                  className="flex items-center justify-center gap-2 text-center text-white/90 hover:text-white transition-colors font-medium text-sm sm:text-base"
                >
                  <ArrowRightIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                  המשך לקנות
                </Link>

                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 mt-4 sm:mt-6">
